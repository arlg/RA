	...
	<div class="col_4">
		<div class="portrait_wrapper">
			...
			<?php if( get_field('about_image_4') ): ?>
				<img src="<?php the_field( "about_image_4" ); ?>" alt="<?php the_field( "about_name_4" ); ?>">
			<?php else: ?>
				<img src="<?php bloginfo('template_directory'); ?>/img/portrait2.png">
			<?php endif; ?>
			</div>
			<p class="red_title"><?php the_field( "about_name_4" ); ?></p>
			<p class="red_title job"><?php the_field( "about_statut_4" ); ?></p>
			<?php the_field( "about_bio_4" ); ?>
		</div>
	</div>
	<div class="col_1"></div>
</div>